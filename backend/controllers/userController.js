...
// Api to book apointment
       ...
       //API to get user user appointments for frontend my appointment page
 ...
 const verifyRazorpay  = async (req, res) => {
       try {
         ...
         if(orderInfo.status === 'paid') {
               ...
               res.json({success:true, messsage: "Payment Successful"})
         } else {
            res.json({success:false, messsage: "Payment failed"})
         }
