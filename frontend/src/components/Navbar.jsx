...
// navelink is basically used to navigate to other paege without getting the page refreshed.it is like the anchor tag
...
const navbar = () => {
  ...
  return (
    <div className='flex item-center justify-between text-sm py-4 mb-5 border-b border-b-gray-400'>
        <img onClick={()=>navigate('/')} src={assets.logo} alt=""></img>
